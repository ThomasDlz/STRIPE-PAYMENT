...
function setPaymentDetails(intent) {
  let statusText = "Un problème s'est produit, veuillez réessayer.";
  ...
  document.querySelector('#status-icon').style.backgroundColor =
    iconColor;
  ...
  document.querySelector('#intent-status').textContent =
    intent.status;
